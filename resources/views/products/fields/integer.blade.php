<div class="form-group xxs-pt-40 clearfix{{ $errors->has('specs.'.$field['id']) ? ' has-error' : '' }}">
    ...
    <div class="col-xs-10 col-sm-7">
        ...
        {!! Form::input('number',"specs[{$field['id']}]", (isset($field['pivot']) ? $field['pivot']['value'] : null), ['class' => 'form-control font-droidkufi xxs-pt-10 xxs-pb-30 xxs-pr-0 text-right lang-ltr','placeholder'=>$field['default']]) !!}
