@if(isset($silver_products) && isset($silver_left_products) && count($silver_products) >= 4)
<div class="boxed-offers rank-silver offers xxs-mt-40">
    <div class="container">
        <div class="row">
            @if(isset($silver_products) && count($silver_products) > 0)
            <div class="col-xs-12 col-md-9 col-lg-9 xxs-mb-20 lg-mb-0">
                <div class="offers-box bg-light border-radius-md card-dp-2 clearfix">
                    <div class="box-title border-bottom-solid-lightgray-1 xxs-mb-20">
                        <h6 class="text-bold font-droidkufi xxs-p-20 text-darkgray"> عروض فضية </h6>
                    </div>
                    <div class="clearfix xxs-p-20 flex-cols">
                        @foreach($silver_products as $product)
                        ...
                        <div class="offer-card read-more col-xs-12 col-sm-6 col-md-4 flex-item">
                            <div class="bg-lightgray text-center border-radius-sm">
                                <a href="{!! route('products.silver') !!}" class="btn btn-sm btn-dark btn-link xxs-mt-5 xxs-mb-5 xxs-pt-40 xxs-pb-20">
                                    <div> عرض المزيد</div>
            ...
            @endif
            @if(isset($silver_left_products) && count($silver_left_products) > 0)
            <div class="col-xs-12 col-md-3 col-lg-3">
                @foreach($silver_left_products as $product)
