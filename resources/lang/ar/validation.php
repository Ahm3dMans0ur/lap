...
return [
    ...
    */
    ...
    'alpha_dash'           => 'يجب أن لا يحتوي الحقل :attribute على رموز خاصة.',
    ...
    'min_width' => 'يجب أن يحتوي الحقل :attribute على الأقل على :min',
    ...
    'searchFieldRequired'  => 'حقل البحث مطلوب',
    'searchCatFieldRequired'  => 'حقل القسم مطلوب',
    ...
    */
    ...
    'custom'               => [
        ...
        'logo' => [
            'dimensions' => 'ابعاد :attribute يجب ان تكون اكثر من 900 عرض / 350 طول'
        ],
        'auction_end' => [
            'before' => 'تاريخ إنتهاء المزاد يجب ان يكون خلال ٣٠ يوم'
        ],
        'checkboxTermsAndCondition' => [
            'required' => 'رجاء مراجعة الشروط و الاحكام و الموافقة عليها'
        ],
        'file.*' => [
            'dimensions' => 'ابعاد الملف  المرفوع رقم :attribute غير متوافقة مع المطلوب رجاء تعديل الملف.'
        ]
    ],
